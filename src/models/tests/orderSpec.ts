...
describe('- Order Model', () => {
    ...
    it('Should create an order with correct user_id', async () => {
    ...
    it('Return current open order from user_id', async () => {
    ...
    it('Return completed orders from user_id', async () => {
    ...
    it('Get order products with order_id', async () => {
